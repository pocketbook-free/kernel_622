...
static int enter_suspend_state(int level)
{
	hw_set_deepsuspend(level);
	enter_state(level);
}
...
static int __init pm_init(void)
{
	...
	hw_set_deepsuspend_level_ctrl(enter_suspend_state);
