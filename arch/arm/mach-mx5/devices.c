...
#define GPIO_4_1	(3*32 + 1)
#define GPIO_4_3	(3*32 + 3)
#define GPIO_4_4	(3*32 + 4)
#define GPIO_4_6	(3*32 + 6)
#define GPIO_4_14	(3*32 + 14)

#define GPIO_KEY_HOME	0x01
#define GPIO_KEY_BACK	0x02
#define GPIO_KEY_VOLUP	0x03
#define GPIO_KEY_MENU	0x04
#define GPIO_KEY_POWER	0x05
...
struct gpio_keys_platform_data gpiokeys_platdata = {
	.buttons 	= gpio_keys,
...
struct platform_device mxc_usbdr_udc_device = {
 ...
 struct platform_device usb_adapter_device = 
{
	.name = "usb_adapter",
	.id 	= 0,
	.resource	   = usbotg_udc_resources,
